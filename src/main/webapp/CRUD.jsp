...
<body id="top">
            ...
            <div class="row">
                <div class="col-md-10 col-lg-8 mx-auto">
                    <div class="site-heading">
                        <h1>Practica #3 <%= request.getSession().getAttribute("usuario")%></h1>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div id="center" style="display: inline-flex;">
        <div id="divForm" style="padding-left: 30px;max-width: 30%;display: inline-block;vertical-align: top;margin-right: 50px;">
            ...
            <div class="alert alert-success" role="alert" style="display: none;"><span>¡Se agregó el empleado con éxito!</span></div>
...
<section>
  ...
  <div class="tbl-content">
    <table cellpadding="0" cellspacing="0" border="0">
      <tbody>
        <tr>
          <td>Cristian Aarón</td>
          <td>Ayala Chacón</td>
          <td>4524525</td>
          <td style="display:inline-flex;">              
            <button class="add"  style="margin-right:10px" data-toggle="modal" data-target="#modal-1">
<i class="fa fa-trash"></i>
</button>
              <button class="warningButtom" data-toggle="modal" data-target="#modal-2">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>¿Está segur@ de querer eliminar el empleado?</p>
                </div>
                <div class="modal-footer"><button class="btn btn-light" type="button" data-dismiss="modal">Cerrar</button><button class="btn btn-danger" type="button">Eliminar</button></div>
            </div>
        </div>
    </div>
